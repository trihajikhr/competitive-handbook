...
Jika kamu bertanya-tanya, kenapa nilai `n` harus ditambahkan dengan 1, ada penjelasan yang masuk akan dibawah ini.
...
## 📌 Catatan: Graph dengan Adjacency List (Index 0-based vs 1-based)
