...
---
---
# 1 | Soal 1 Directed Graph (Tanpa Bobot)
...
### 1.2.1 | Header dan Fungsi Fast I/O
...
### 1.2.2 | Deklarasi Variabel dan Input
...
### 1.2.5 | Menampilkan Matriks Adjacency
...
# 2 | Soal 2 Directed Graph (Dengan Bobot)
...
### 2.2.1 | Deklarasi Matriks Adjacency dengan INF:
...
### 2.2.2 | Menandai Diri Sendiri dengan Jarak 0:
...
### 2.2.4 | Menampilkan Matriks Adjacency:
...
### 3.1.1 | Menandakan Tidak Ada Edge (Ketidakterhubungan):
...
### 3.1.2 | Memudahkan Implementasi Algoritma Pathfinding:
...
### 3.1.3 | Konsistensi dalam Matriks:
...
### 3.1.4 | Fleksibilitas dalam Pembandingan:
...
## 3.2 | Contoh Perbandingan:

### 3.2.1 | Tanpa `INF` (misalnya menggunakan `0`):
...
## 3.3 | Lalu apa maksud dari INF=1e9?
