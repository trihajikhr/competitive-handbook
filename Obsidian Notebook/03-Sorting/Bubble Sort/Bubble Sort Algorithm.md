...
### 1. Iterasi Pertama (Membandingkan dan Menukar)
...
![[01-Algoritma-Bubble-Sort.png|500]]
...
![[01-Algoritma-Bubble-Sort-3.png|500]]
...
2. **Average Case (Kasus Rata-rata)** - $O(n^2)$
...
3.  **Worst Case (Kasus Terburuk)** - $O(n^2)$ 
...
## Keunggulan dan kelemahan Bubble Sort
