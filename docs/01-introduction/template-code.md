...
# Template code untuk Competitive Programming
...
> Untuk bisa memahami dengan baik Advanced template code ini, pelajari terlebih dahulu materi [Introduction to CP](introduction-to-cp.md) hingga selesai! 
...
### Template Dasar Competitive Programming
...
### Penjelasan dan Fitur:

1. Header `<bits/stdc++.h>` → Mengimpor semua pustaka STL sekaligus.
...
### Variasi Template untuk CP

- Jika Butuh Graph / BFS / DFS
      ```cpp
...
- Jika Butuh Modular Exponentiation
     ```cpp
...
### [Neilblaze](https://gist.github.com/Neilblaze/dcf6113fa5e63fc938502f1d742365c4#file-cpp_template-cpp)
...
### [ncduy0303](https://github.com/ncduy0303/Competitive-Programming/blob/master/Contest%20Template/main.cpp)
...
### [7oSkaaa](https://github.com/7oSkaaa/CP-Templates/blob/main/Template.cpp#L39)
